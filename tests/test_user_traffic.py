...
class UserTrafficPanelTests(unittest.TestCase):
    def test_user_menu_opens_traffic_analysis_modal(self):
        ...
        self.assertIn("function iconSvg", panel)
        ...
        self.assertIn(".modal.traffic-modal{width:100%;height:100%", panel)
        self.assertIn("min-width:0;min-height:0", panel)
        self.assertNotIn("width:98vw", panel)
        self.assertNotIn("96vh", panel)
        self.assertIn("traffic-board", panel)
        self.assertIn("traffic-insights", panel)
        self.assertIn("trafficSessionAvg", panel)
        self.assertIn("function renderDayNight", panel)
